    ...
    public String GetLongestWord() {
        for (String word : words) {
            if (word.length() > longestWord.length()) {//ramblar ut alla ord i array och sen varje bokstav av det ordet
                // sen jämförst den med de longetWord som hela tiden fulls in i ordning av de längsta ordet till det inte finns ett ord i arrayn som är längre så returer den det ordet
                longestWord = word;
            }
        }
        return longestWord;
